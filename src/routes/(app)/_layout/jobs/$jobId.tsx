    ...
    <div className="space-y-6 pb-10">
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <span
            className={`inline-flex items-center rounded-md px-2 py-1 text-xs font-medium ${STATUS_STYLES[job.status] ?? "bg-gray-100 text-gray-600"}`}>
      ...
      <Card className="p-4">
        ...
        <JobStageStepper
          ...
          stages={
            job.template?.stages ??
            JOB_STAGES[job.jobType as JobTypeValue] ??
            []
          }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="p-6 space-y-4">
          ...
          <MetaRow label="Priority">
            <span
              className={`inline-flex items-center rounded-md px-2 py-1 text-xs font-medium ${PRIORITY_STYLES[job.priority] ?? "bg-gray-100 text-gray-600"}`}>
