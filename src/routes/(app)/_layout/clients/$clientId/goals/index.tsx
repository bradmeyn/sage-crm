...
import { goalKeys, useGoals, useDeleteGoal } from '#/features/clients/goals/hooks'
    ...
    <Card className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Financial goals and milestones</p>
        </div>
      ...
      {goals.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-muted-foreground mb-4">Add the first goal for this client</p>
          <GoalDialog
            clientId={clientId}
            trigger={
              <Button>
