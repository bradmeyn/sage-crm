        ...
        <div className="bg-white border-b">
          <div className="mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="-mb-px flex space-x-8">
              ...
              <NavTab
                to="/clients/$clientId/cashflow"
                params={{ clientId: client.id }}>
                Cashflow
              </NavTab>
              <NavTab
                to="/clients/$clientId/goals"
                params={{ clientId: client.id }}>
                Goals
              </NavTab>
              <NavTab
                to="/clients/$clientId/insurance"
                params={{ clientId: client.id }}>
                Insurance
              </NavTab>
              <NavTab
                to="/clients/$clientId/soa"
                params={{ clientId: client.id }}>
                Advice
              </NavTab>
              <NavTab
                to="/clients/$clientId/jobs"
                params={{ clientId: client.id }}>
                Jobs
              </NavTab>
              <NavTab
