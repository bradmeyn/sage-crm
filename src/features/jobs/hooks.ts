...
export function useCreateJob() {
  ...
  return useMutation({
    mutationFn: (data: Parameters<typeof createJob>[0]["data"]) =>
      createJob({ data }),
    onSuccess: (_, variables) => {
      queryClient.invalidateQueries({ queryKey: jobKeys.list() });
      queryClient.invalidateQueries({
        queryKey: jobKeys.byClient(variables.clientId),
      });
    },
  });
}
...
export function useUpdateJob() {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: (data: Parameters<typeof updateJob>[0]["data"]) =>
      updateJob({ data }),
    onSuccess: (updated) => {
      queryClient.invalidateQueries({ queryKey: jobKeys.list() });
...
export function useUpdateJobStage() {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: (data: Parameters<typeof updateJobStage>[0]["data"]) =>
      updateJobStage({ data }),
    onSuccess: (updated) => {
      queryClient.invalidateQueries({ queryKey: jobKeys.list() });
      queryClient.invalidateQueries({ queryKey: jobKeys.all });
...
export function useToggleJobTask(jobId: string) {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: (data: Parameters<typeof toggleJobTask>[0]["data"]) =>
      toggleJobTask({ data }),
...
export function useAddJobTask(jobId: string) {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: (data: Parameters<typeof addJobTask>[0]["data"]) =>
      addJobTask({ data }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: jobKeys.detail(jobId) });
    },
...
export function useDeleteJobTask(jobId: string) {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: (data: Parameters<typeof deleteJobTask>[0]["data"]) =>
      deleteJobTask({ data }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: jobKeys.detail(jobId) });
    },
...
export function useAddJobClient(jobId: string) {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: (data: Parameters<typeof addJobClient>[0]["data"]) =>
      addJobClient({ data }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: jobKeys.detail(jobId) });
      queryClient.invalidateQueries({ queryKey: jobKeys.list() });
...
export function useRemoveJobClient(jobId: string) {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: (data: Parameters<typeof removeJobClient>[0]["data"]) =>
      removeJobClient({ data }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: jobKeys.detail(jobId) });
      queryClient.invalidateQueries({ queryKey: jobKeys.list() });
      queryClient.invalidateQueries({ queryKey: jobKeys.all });
...
export function useAddJobComment(jobId: string) {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: (data: Parameters<typeof addJobComment>[0]["data"]) =>
      addJobComment({ data }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: jobKeys.timeline(jobId) });
    },
...
export function useDeleteJobComment(jobId: string) {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: (data: Parameters<typeof deleteJobComment>[0]["data"]) =>
      deleteJobComment({ data }),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: jobKeys.timeline(jobId) });
    },
  });
